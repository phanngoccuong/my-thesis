            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0);">Semester Edit</a></li>
                    </ol>
                </div>
            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            value="{{ $semesters[0]->semester_name }}" name="semester_name" id="semester_name">
                                            @error('semester_name')
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <button type="button" class="btn btn-light"><a href="{{ route('semester/list') }}">Back</a></button>
                                    </div>
                                </div>
                            </form>
                        </div>
