            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0);">Classroom Edit</a></li>
                    </ol>
                </div>
            </div>
                            ...
                            <form action="{{ route('classroom/update') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <button type="button" class="btn btn-light"><a href="{{ route('classroom/list') }}">Back</a></button>
                                    </div>
                                </div>
                            </form>
                        </div>
